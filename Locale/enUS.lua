...
L["The maximum number of auctions an item can have before it stops being considered a Market Trap candidate."] = "The maximum number of auctions an item can have before it stops being considered a Market Trap candidate."
...
L["The Market Trap scoring formula. Available variables include scarcity, quantityScarcity, valueGap, numAuctions, quantity, itemBuyout, and targetPrice."] = "The Market Trap scoring formula. Available variables include scarcity, quantityScarcity, valueGap, numAuctions, quantity, itemBuyout, and targetPrice."
