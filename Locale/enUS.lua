...
L["3M"] = "3M"
L["6M"] = "6M"
L["A comma-separated list of seller names to ignore when they are the top seller during a Cancel Scan."] = "A comma-separated list of seller names to ignore when they are the top seller during a Cancel Scan."
...
L["Bid percentage"] = "Bid percentage"
...
L["Did not post %s because your post size (%s) is invalid. Check your settings."] = "Did not post %s because your post size (%s) is invalid. Check your settings."
...
L["Ignored top sellers"] = "Ignored top sellers"
L["Import"] = "Import"
...
L["Automatically open all mail when the mailbox is opened."] = "Automatically open all mail when the mailbox is opened."
...
L["The number of items to post per auction."] = "The number of items to post per auction."
...
L["Top seller is ignored for canceling."] = "Top seller is ignored for canceling."
...
L["Undercut bid price"] = "Undercut bid price"
L["Undercut bid price by 1c when posting from Browsing"] = "Undercut bid price by 1c when posting from Browsing"
L["Browsing post undercut amount"] = "Browsing post undercut amount"
L["The amount to undercut the lowest auction by when posting from Browsing."] = "The amount to undercut the lowest auction by when posting from Browsing."
L["If enabled, the bid price will be undercut by 1c when posting from Browsing."] = "If enabled, the bid price will be undercut by 1c when posting from Browsing."
L["When posting auctions, the bid price will be set this amount below the buyout price."] = "When posting auctions, the bid price will be set this amount below the buyout price."
L["%s: score %d, %d auctions, %d quantity, current %s, target %s"] = "%s: score %d, %d auctions, %d quantity, current %s, target %s"
L["%s: score %d, %d sellers, %d quantity, current %s, target %s"] = "%s: score %d, %d sellers, %d quantity, current %s, target %s"
L["Active"] = "Active"
L["Action"] = "Action"
L["Candidate cost is above the per-item limit: %s / %s."] = "Candidate cost is above the per-item limit: %s / %s."
L["Candidate is ready for controlled execution."] = "Candidate is ready for controlled execution."
L["Candidate passed controlled execute checks."] = "Candidate passed controlled execute checks."
L["Candidate Review"] = "Candidate Review"
L["Controlled Execute"] = "Controlled Execute"
L["Controlled Execute actions will appear here."] = "Controlled Execute actions will appear here."
L["Controlled execute spend limit reached: %s / %s."] = "Controlled execute spend limit reached: %s / %s."
L["Controls how Market Trap scores and prices candidates."] = "Controls how Market Trap scores and prices candidates."
L["Controls how Market Trap scores scan results."] = "Controls how Market Trap scores scan results."
L["Controls Market Trap spend limits and execution safeguards."] = "Controls Market Trap spend limits and execution safeguards."
L["Controls Market Trap spend limits and posting safeguards."] = "Controls Market Trap spend limits and posting safeguards."
L["Controls which auctions are considered during a Market Trap discovery scan."] = "Controls which auctions are considered during a Market Trap discovery scan."
L["Commodity Search"] = "Commodity Search"
L["Discovery Scan"] = "Discovery Scan"
L["Execution"] = "Execution"
L["Execute Actions"] = "Execute Actions"
L["Favorite Traps"] = "Favorite Traps"
L["If enabled, Market Trap keeps controlled execute actions behind the normal TSM and Auction House confirmation flow."] = "If enabled, Market Trap keeps controlled execute actions behind the normal TSM and Auction House confirmation flow."
L["If enabled, Market Trap will reject candidates when required sale data is missing."] = "If enabled, Market Trap will reject candidates when required sale data is missing."
L["Ignore candidates with missing sale data"] = "Ignore candidates with missing sale data"
L["Inactive"] = "Inactive"
L["Market Trap"] = "Market Trap"
L["Market Trap only supports commodities."] = "Market Trap only supports commodities."
L["Maximum auctions"] = "Maximum auctions"
L["Maximum candidates"] = "Maximum candidates"
L["Maximum deposit cost"] = "Maximum deposit cost"
L["Maximum quantity"] = "Maximum quantity"
L["Maximum sellers"] = "Maximum sellers"
L["Maximum spend per item"] = "Maximum spend per item"
L["Maximum total spend"] = "Maximum total spend"
L["Minimum score"] = "Minimum score"
L["No candidate selected."] = "No candidate selected."
L["No auctionable quantity for this favorite trap item."] = "No auctionable quantity for this favorite trap item."
L["Opening the post action for this candidate."] = "Opening the post action for this candidate."
L["Post Trap"] = "Post Trap"
L["Require confirmation flow"] = "Require confirmation flow"
L["Review Candidate"] = "Review Candidate"
L["Run Scan"] = "Run Scan"
L["Scans the selected groups and surfaces items with low auction count and low available quantity."] = "Scans the selected groups and surfaces items with low auction count and low available quantity."
L["Score"] = "Score"
L["Score formula"] = "Score formula"
L["Score too low: %d / %d."] = "Score too low: %d / %d."
L["Select a result after the discovery scan to review its score, limits, and target repost price."] = "Select a result after the discovery scan to review its score, limits, and target repost price."
L["Select a result and review the candidate."] = "Select a result and review the candidate."
L["Select an auction first."] = "Select an auction first."
L["Show results below minimum score"] = "Show results below minimum score"
L["Status"] = "Status"
L["Stop Scan"] = "Stop Scan"
L["Target price could not be evaluated for the selected item."] = "Target price could not be evaluated for the selected item."
L["Target repost price"] = "Target repost price"
L["Trap post quantity"] = "Trap post quantity"
L["The number of items to post when reposting a Market Trap candidate."] = "The number of items to post when reposting a Market Trap candidate."
L["The maximum deposit cost Market Trap should allow when reviewing controlled execute candidates."] = "The maximum deposit cost Market Trap should allow when reviewing controlled execute candidates."
L["The maximum gold Market Trap should allow for a single candidate during controlled execute."] = "The maximum gold Market Trap should allow for a single candidate during controlled execute."
L["The maximum number of candidates to review from a discovery scan."] = "The maximum number of candidates to review from a discovery scan."
L["The maximum number of sellers an item can have before it stops being considered a Market Trap candidate."] = "The maximum number of sellers an item can have before it stops being considered a Market Trap candidate."
L["The maximum total gold Market Trap should allow during a controlled execute session."] = "The maximum total gold Market Trap should allow during a controlled execute session."
L["The maximum total quantity an item can have before it stops being considered a Market Trap candidate."] = "The maximum total quantity an item can have before it stops being considered a Market Trap candidate."
L["The minimum Market Trap score required for controlled execute."] = "The minimum Market Trap score required for controlled execute."
L["If enabled, Discovery Scan will show candidates even when their score is below the minimum score."] = "If enabled, Discovery Scan will show candidates even when their score is below the minimum score."
L["The price source used as the target repost price for Market Trap candidates."] = "The price source used as the target repost price for Market Trap candidates."
L["The Market Trap scoring formula. Scores are clamped from 0 to 100. Available variables include quantityScarcity, sellerScarcity, scarcity, numSellers, numAuctions, quantity, itemBuyout, targetPrice, and valueGap."] = "The Market Trap scoring formula. Scores are clamped from 0 to 100. Available variables include quantityScarcity, sellerScarcity, scarcity, numSellers, numAuctions, quantity, itemBuyout, targetPrice, and valueGap."
L["Too many sellers: %d / %d."] = "Too many sellers: %d / %d."
L["The selected auction is no longer available. Select it again after the scan updates."] = "The selected auction is no longer available. Select it again after the scan updates."
L["The selected auction does not have complete pricing data yet."] = "The selected auction does not have complete pricing data yet."
L["The selected auction does not have item information yet."] = "The selected auction does not have item information yet."
L["Too many auctions: %d / %d."] = "Too many auctions: %d / %d."
L["Too much quantity: %d / %d."] = "Too much quantity: %d / %d."
L["Validated candidates use the existing Browse buy and post controls so every purchase and repost stays under TSM and Auction House confirmation."] = "Validated candidates use the existing Browse buy and post controls so every purchase and repost stays under TSM and Auction House confirmation."
