	...
	return Settings.NewSchema(133, 10)
		:EnterScope("global")
			...
			:EnterNamespace("auctionUIContext")
				...
				:AddTable("marketTrapAuctionScrollingTable", { cols = LibTSMSystem.IsRetail() and { { id = "item", width = 226, hidden = nil }, { id = "score", width = 50, hidden = nil }, { id = "ilvl", width = 32, hidden = nil }, { id = "qty", width = 40, hidden = nil }, { id = "timeLeft", width = 26, hidden = nil }, { id = "seller", width = 136, hidden = nil }, { id = "itemBid", width = 115, hidden = nil }, { id = "bid", width = 115, hidden = true }, { id = "itemBuyout", width = 115, hidden = nil }, { id = "buyout", width = 115, hidden = true }, { id = "bidPct", width = 40, hidden = true }, { id = "pct", width = 40, hidden = nil }, } or { { id = "item", width = 226, hidden = nil }, { id = "score", width = 50, hidden = nil }, { id = "ilvl", width = 32, hidden = nil }, { id = "posts", width = 40, hidden = nil }, { id = "stack", width = 40, hidden = nil }, { id = "timeLeft", width = 26, hidden = nil }, { id = "seller", width = 80, hidden = nil }, { id = "itemBid", width = 115, hidden = nil }, { id = "bid", width = 115, hidden = true }, { id = "itemBuyout", width = 115, hidden = nil }, { id = "buyout", width = 115, hidden = true }, { id = "bidPct", width = 40, hidden = true }, { id = "pct", width = 40, hidden = nil }, }, sortCol = "score", sortAscending = false }, 133)
