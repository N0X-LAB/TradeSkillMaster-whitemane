...
function Schema.Get()
	...
	-- [131] added global.marketTrapOptions, global.auctionUIContext.{marketTrapSelectionDividedContainer,marketTrapAuctionScrollingTable}, char.auctionUIContext.marketTrapGroupTree
	...
	-- [136] added global.opportunitiesOptions and global.auctionUIContext.opportunitiesAuctionScrollingTable
	return Settings.NewSchema(136, 10)
		:EnterScope("global")
			...
			:EnterNamespace("auctionUIContext")
				...
				:AddTable("marketTrapSelectionDividedContainer", { leftWidth = 272 }, 131)
				:AddTable("marketTrapAuctionScrollingTable", { cols = LibTSMSystem.IsRetail() and { { id = "favorite", width = 20, hidden = nil }, { id = "item", width = 226, hidden = nil }, { id = "score", width = 50, hidden = nil }, { id = "ilvl", width = 32, hidden = nil }, { id = "qty", width = 40, hidden = nil }, { id = "timeLeft", width = 26, hidden = nil }, { id = "seller", width = 136, hidden = nil }, { id = "itemBid", width = 115, hidden = nil }, { id = "bid", width = 115, hidden = true }, { id = "itemBuyout", width = 115, hidden = nil }, { id = "buyout", width = 115, hidden = true }, { id = "bidPct", width = 40, hidden = true }, { id = "pct", width = 40, hidden = nil }, } or { { id = "favorite", width = 20, hidden = nil }, { id = "item", width = 226, hidden = nil }, { id = "score", width = 50, hidden = nil }, { id = "ilvl", width = 32, hidden = nil }, { id = "posts", width = 40, hidden = nil }, { id = "stack", width = 40, hidden = nil }, { id = "timeLeft", width = 26, hidden = nil }, { id = "seller", width = 80, hidden = nil }, { id = "itemBid", width = 115, hidden = nil }, { id = "bid", width = 115, hidden = true }, { id = "itemBuyout", width = 115, hidden = nil }, { id = "buyout", width = 115, hidden = true }, { id = "bidPct", width = 40, hidden = true }, { id = "pct", width = 40, hidden = nil }, }, sortCol = "score", sortAscending = false }, 134)
				:AddTable("opportunitiesAuctionScrollingTable", { cols = LibTSMSystem.IsRetail() and { { id = "item", width = 226, hidden = nil }, { id = "ilvl", width = 32, hidden = nil }, { id = "qty", width = 40, hidden = nil }, { id = "timeLeft", width = 26, hidden = nil }, { id = "seller", width = 136, hidden = nil }, { id = "itemBid", width = 115, hidden = nil }, { id = "bid", width = 115, hidden = true }, { id = "itemBuyout", width = 115, hidden = nil }, { id = "buyout", width = 115, hidden = true }, { id = "bidPct", width = 40, hidden = true }, { id = "pct", width = 40, hidden = nil }, } or { { id = "item", width = 226, hidden = nil }, { id = "ilvl", width = 32, hidden = nil }, { id = "posts", width = 40, hidden = nil }, { id = "stack", width = 40, hidden = nil }, { id = "timeLeft", width = 26, hidden = nil }, { id = "seller", width = 80, hidden = nil }, { id = "itemBid", width = 115, hidden = nil }, { id = "bid", width = 115, hidden = true }, { id = "itemBuyout", width = 115, hidden = nil }, { id = "buyout", width = 115, hidden = true }, { id = "bidPct", width = 40, hidden = true }, { id = "pct", width = 40, hidden = nil }, }, sortCol = "pct", sortAscending = true }, 136)
			...
			:LeaveNamespace()
			:EnterNamespace("marketTrapOptions")
				:AddNumber("maxAuctions", 3, 131)
				:AddNumber("maxQuantity", 20, 131)
				:AddString("maxSpendPerItem", "100g", 131)
				...
				:AddBoolean("showBelowMinScore", true, 133)
				:AddBoolean("ignoreNoSaleData", true, 131)
				:AddBoolean("requireConfirmation", true, 131)
			:LeaveNamespace()
			:EnterNamespace("opportunitiesOptions")
				:AddString("valueSource", "dbmarket", 136)
				:AddNumber("maxPricePct", 70, 136)
				:AddString("minMarketValue", "10g", 136)
				:AddNumber("minAuctions", 1, 136)
				:AddNumber("maxCandidates", 100, 136)
				:AddNumber("maxBuyQuantity", 20, 136)
			:LeaveNamespace()
			...
			:EnterNamespace("userData")
				...
				:AddTable("marketTrapFavorites", {}, 134)
		...
		:EnterScope("char")
			...
			:EnterNamespace("auctionUIContext")
				...
				:AddTable("marketTrapGroupTree", { collapsed = {}, unselected = {} }, 131)
			:LeaveNamespace()
			:EnterNamespace("bankingUIContext")
